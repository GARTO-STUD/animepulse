...
// Bricolage Grotesque — expressive, editorial, bold variable font for headings & logo
// Lato — clean, highly legible humanist font for body text
...
export const metadata: Metadata = {
  ...
  title: {
    default: "AnimePulse — Anime News, Trending & Reviews 2026",
  ...
  keywords: [
    "anime news 2026", "trending anime 2026", "best anime 2026", "anime reviews",
    "top anime list", "new anime season 2026", "anime rankings", "watch anime",
    ...
    "myanimelist top anime", "seasonal anime 2026", "anime episodes",
  ...
  openGraph: {
    ...
    url: APP_URL,
    siteName: "AnimePulse",
    title: "AnimePulse — Anime News, Trending & Reviews 2026",
...
const websiteSchema = {
  ...
  publisher: {
    ...
    sameAs: [
      ...
      "https://instagram.com/animepulse",
      "https://youtube.com/animepulse",
    ],
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 4, name: "Calendar", item: `${APP_URL}/calendar` },
    { "@type": "ListItem", position: 5, name: "Top 10",   item: `${APP_URL}/top-10` },
    { "@type": "ListItem", position: 6, name: "Reviews",  item: `${APP_URL}/reviews` },
  ],
};
  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel="alternate" type="application/rss+xml" title="AnimePulse RSS Feed" href="/feed.xml" />
      ...
      <body className={`${lato.variable} ${bricolage.variable} font-sans min-h-screen flex flex-col bg-[#f8f9fc]`}>
        <Header />
