    ...
    <div className="min-h-screen py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <h2 className="text-2xl font-semibold text-[#0f172a] mt-8 mb-4">1. Acceptance of Terms</h2>
          <p className="text-[#64748b] mb-6">
          ...
          <h2 className="text-2xl font-semibold text-[#0f172a] mt-8 mb-4">2. Use License</h2>
          <p className="text-[#64748b] mb-6">
          ...
          <ul className="list-disc list-inside text-[#64748b] mb-6 space-y-2">
          ...
          <h2 className="text-2xl font-semibold text-[#0f172a] mt-8 mb-4">3. User Conduct</h2>
          <p className="text-[#64748b] mb-6">
          ...
          <h2 className="text-2xl font-semibold text-[#0f172a] mt-8 mb-4">4. Content and Copyright</h2>
          <p className="text-[#64748b] mb-6">
          ...
          <h2 className="text-2xl font-semibold text-[#0f172a] mt-8 mb-4">5. Third-Party Links</h2>
          <p className="text-[#64748b] mb-6">
          ...
          <h2 className="text-2xl font-semibold text-[#0f172a] mt-8 mb-4">6. Disclaimer of Warranties</h2>
          <p className="text-[#64748b] mb-6">
          ...
          <h2 className="text-2xl font-semibold text-[#0f172a] mt-8 mb-4">7. Limitation of Liability</h2>
          <p className="text-[#64748b] mb-6">
          ...
          <h2 className="text-2xl font-semibold text-[#0f172a] mt-8 mb-4">8. Indemnification</h2>
          <p className="text-[#64748b] mb-6">
          ...
          <h2 className="text-2xl font-semibold text-[#0f172a] mt-8 mb-4">9. Termination</h2>
          <p className="text-[#64748b] mb-6">
          ...
          <h2 className="text-2xl font-semibold text-[#0f172a] mt-8 mb-4">10. Governing Law</h2>
          <p className="text-[#64748b] mb-6">
            These Terms shall be governed by and construed in accordance with the laws, 
            without regard to its conflict of law provisions.
          </p>

          <h2 className="text-2xl font-semibold text-[#0f172a] mt-8 mb-4">11. Changes to Terms</h2>
          <p className="text-[#64748b] mb-6">
          ...
          <h2 className="text-2xl font-semibold text-[#0f172a] mt-8 mb-4">12. Contact Information</h2>
