...
export const metadata: Metadata = {
  ...
  keywords: ['anime reviews 2026', 'anime ratings', 'best anime to watch', 'anime review site', 'is this anime worth watching'],
  alternates: { canonical: '/reviews' },
  openGraph: {
    title: 'Anime Reviews 2026 | AnimePulse',
