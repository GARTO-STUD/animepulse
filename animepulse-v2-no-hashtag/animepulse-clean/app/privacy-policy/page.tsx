  ...
  return (
    <div className="min-h-screen py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-bold text-[#0f172a] mb-4">Privacy Policy</h1>
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <h2 className="text-2xl font-semibold text-[#0f172a] mt-8 mb-4">1. Information We Collect</h2>
          <p className="text-[#64748b] mb-4">We may collect the following types of information:</p>
          ...
          <h2 className="text-2xl font-semibold text-[#0f172a] mt-8 mb-4">2. How We Use Your Information</h2>
          <ul className="list-disc list-inside text-[#64748b] mb-6 space-y-2">
          ...
          <h2 className="text-2xl font-semibold text-[#0f172a] mt-8 mb-4">3. Data Protection</h2>
          <p className="text-[#64748b] mb-6">
          ...
          <h2 className="text-2xl font-semibold text-[#0f172a] mt-8 mb-4">4. Third-Party Services</h2>
          <p className="text-[#64748b] mb-6">
          ...
          <h2 className="text-2xl font-semibold text-[#0f172a] mt-8 mb-4">5. Your Rights</h2>
          ...
          <h2 className="text-2xl font-semibold text-[#0f172a] mt-8 mb-4">6. Children&apos;s Privacy</h2>
          <p className="text-[#64748b] mb-6">
            Our website is not intended for children under 13. We do not knowingly collect 
            personal information from children under 13.
          </p>

          <h2 className="text-2xl font-semibold text-[#0f172a] mt-8 mb-4">7. Changes to This Policy</h2>
          <p className="text-[#64748b] mb-6">
            We may update our Privacy Policy from time to time. We will notify you of any 
            changes by posting the new Privacy Policy on this page.
          </p>

          <h2 className="text-2xl font-semibold text-[#0f172a] mt-8 mb-4">8. Contact Us</h2>
