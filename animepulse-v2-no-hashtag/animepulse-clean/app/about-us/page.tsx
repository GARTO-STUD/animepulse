...
export default function AboutUs() {
  return (
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden bg-[#f8f9fc] py-24">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="flex items-center justify-center gap-2.5 mb-7">
            ...
            <span className="text-2xl font-black text-[#0f172a] tracking-tight">Anime<span className="text-[#e85d04]">Pulse</span></span>
          </div>
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-black text-[#0f172a] mb-6 leading-tight">
            The Pulse of the<br />
      ...
      {/* Stats */}
      <section className="border-y border-[#e2e8f4] bg-white">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="text-3xl font-black text-[#0f172a] mb-6">Built for fans who want more</h2>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link href="/news" className="px-6 py-3 bg-[#e85d04] hover:bg-[#f48c06] text-[#0f172a] font-bold rounded-xl transition-all text-sm glow-orange">
                Read the News
              </Link>
              <Link href="/contact-us" className="px-6 py-3 bg-white/10 hover:bg-white/15 text-[#0f172a] font-bold rounded-xl border border-white/10 transition-all text-sm">
                Get in Touch
              </Link>
            </div>
          </div>

          <div className="bg-white border border-[#e2e8f4] rounded-2xl p-8 relative overflow-hidden">
            ...
            <div className="relative space-y-1">
              {[
                ...
                <div key={label} className="py-4 border-b border-[#e2e8f4] last:border-0">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-[#64748b] text-sm">{label}</span>
                    <span className="text-white font-black text-sm">{value}</span>
                  </div>
                  <div className="w-full h-1 bg-[#e2e8f4] rounded-full overflow-hidden">
      ...
      {/* What We Offer */}
      <section className="bg-white border-y border-[#e2e8f4] py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl font-black text-[#0f172a]">Everything in One Place</h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              <div
                key={label}
                className="bg-[#f8f9fc] rounded-2xl p-6 border border-[#e2e8f4]"
      ...
      {/* CTA */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="relative rounded-2xl overflow-hidden border border-[#e85d04]/20 bg-gradient-to-br from-[#e85d04]/10 via-orange-50 to-white p-10 sm:p-14 text-center">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_left,rgba(232,93,4,0.12),transparent_60%)]" />
          <div className="relative">
            <h2 className="text-3xl sm:text-4xl font-black text-[#0f172a] mb-4">Start Exploring</h2>
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              <Link href="/trending" className="px-7 py-3.5 bg-[#e85d04] hover:bg-[#f48c06] text-[#0f172a] font-bold rounded-xl transition-all glow-orange">
                Trending Anime
              </Link>
              <Link href="/blog" className="px-7 py-3.5 bg-white/10 hover:bg-white/15 text-[#0f172a] font-bold rounded-xl border border-white/10 transition-all">
                Read the Blog
              </Link>
            </div>
          </div>
